#!/usr/bin/env python3
import cv2
vidcap = cv2.VideoCapture('/home/GPU/tsutar/local_storage/judo-footage-analysis/interim/mat-2-trunc.mp4')
...
img = cv2.imread('/home/GPU/tsutar/home_gtl/intro_to_res/cs8813-judo-footage-analysis/user/tsutar/frames/frame137.jpg')
save_path = '/home/GPU/tsutar/home_gtl/intro_to_res/'
size = (int(vidcap.get(3)), int(vidcap.get(4)))

result = cv2.VideoWriter(save_path+'/mat-2-pose.mp4',  
